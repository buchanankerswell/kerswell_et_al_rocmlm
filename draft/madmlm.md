...
![Elapsed times for computing MADs of increasing size. Note that MAGEMin (dashed lines with squares) was ran in parallel on 6 CPU cores, while Perple_X (solid lines with circles) has no parallel capabilities.](assets/figs/benchmark-times.png){#fig:benchmark-times}
...
![PT-density diagrams showing density (in g/cm$^3$) calculated by (a) MAGEMin and (b) Perple_X for a PUM bulk composition (@tbl:benchmark-comps). (c, d) PT-density diagrams showing density (in g/cm$^3$) inferred by Support Vector models trained on (a, b), respectively. (e, f) PT-error diagrams showing the percent difference between (a, b) and (c, d), respectively.](assets/figs/surf-PUM-128x128-DensityOfFullAssemblage-Support-Vector.png)

![PT-density diagrams showing density (in g/cm$^3$) calculated by (a) MAGEMin and (b) Perple_X for a PUM bulk composition (@tbl:benchmark-comps). (c, d) PT-density diagrams showing density (in g/cm$^3$) inferred by Random Forest models trained on (a, b), respectively. (e, f) PT-error diagrams showing the percent difference between (a, b) and (c, d), respectively.](assets/figs/surf-PUM-128x128-DensityOfFullAssemblage-Random-Forest.png)

![PT-density diagrams showing density (in g/cm$^3$) calculated by (a) MAGEMin and (b) Perple_X for a PUM bulk composition (@tbl:benchmark-comps). (c, d) PT-density diagrams showing density (in g/cm$^3$) inferred by Gradient Boost models trained on (a, b), respectively. (e, f) PT-error diagrams showing the percent difference between (a, b) and (c, d), respectively.](assets/figs/surf-PUM-128x128-DensityOfFullAssemblage-Gradient-Boost.png)

![PT-density diagrams showing density (in g/cm$^3$) calculated by (a) MAGEMin and (b) Perple_X for a PUM bulk composition (@tbl:benchmark-comps). (c, d) PT-density diagrams showing density (in g/cm$^3$) inferred by K Nearest models trained on (a, b), respectively. (e, f) PT-error diagrams showing the percent difference between (a, b) and (c, d), respectively.](assets/figs/surf-PUM-128x128-DensityOfFullAssemblage-K-Nearest.png)

![PT-density diagrams showing density (in g/cm$^3$) calculated by (a) MAGEMin and (b) Perple_X for a PUM bulk composition (@tbl:benchmark-comps). (c, d) PT-density diagrams showing density (in g/cm$^3$) inferred by Neural Network 1L models trained on (a, b), respectively. (e, f) PT-error diagrams showing the percent difference between (a, b) and (c, d), respectively.](assets/figs/surf-PUM-128x128-DensityOfFullAssemblage-Neural-Network-1L.png)

![PT-density diagrams showing density (in g/cm$^3$) calculated by (a) MAGEMin and (b) Perple_X for a PUM bulk composition (@tbl:benchmark-comps). (c, d) PT-density diagrams showing density (in g/cm$^3$) inferred by Neural Network 2L models trained on (a, b), respectively. (e, f) PT-error diagrams showing the percent difference between (a, b) and (c, d), respectively.](assets/figs/surf-PUM-128x128-DensityOfFullAssemblage-Neural-Network-2L.png)

![PT-density diagrams showing density (in g/cm$^3$) calculated by (a) MAGEMin and (b) Perple_X for a PUM bulk composition (@tbl:benchmark-comps). (c, d) PT-density diagrams showing density (in g/cm$^3$) inferred by Neural Network 3L models trained on (a, b), respectively. (e, f) PT-error diagrams showing the percent difference between (a, b) and (c, d), respectively.](assets/figs/surf-PUM-128x128-DensityOfFullAssemblage-Neural-Network-3L.png)

![PT-density diagrams showing density (in g/cm$^3$) calculated by (a) MAGEMin and (b) Perple_X for a PUM bulk composition (@tbl:benchmark-comps). (c, d) PT-density diagrams showing density (in g/cm$^3$) inferred by Decision Tree models trained on (a, b), respectively. (e, f) PT-error diagrams showing the percent difference between (a, b) and (c, d), respectively.](assets/figs/surf-PUM-128x128-DensityOfFullAssemblage-Decision-Tree.png)
